    ...
    <div className="pt-20 pb-32 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center mb-32">
          <div className="order-2 lg:order-1 space-y-8 animate-fadeInUp">
          ...
          <div className="order-1 lg:order-2 relative animate-fadeInUp">
            <div className="rounded-[60px] overflow-hidden shadow-2xl border-none">
              <img 
        ...
        <div className="mb-32 relative group">
           <img 
             ...
             alt="オフィス全景"
             className="w-full h-[500px] object-cover rounded-[60px] shadow-2xl grayscale-[20%] hover:grayscale-0 transition-all duration-700 border-none"
           />
        ...
        {/* Profile Table */}
        <div className="bg-[#f0f7f8] rounded-[50px] p-10 md:p-20 shadow-inner">
          ...
          <div className="bg-white rounded-[40px] overflow-hidden shadow-xl border border-white">
